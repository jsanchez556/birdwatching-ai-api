export const CONVERSATION_SUMMARY_PROMPT_VERSION = '1.0.0';
...
export const CONVERSATION_SUMMARY_SYSTEM_PROMPT = [
  ...
  'Preserve reservation state, selected tours, participant counts, itinerary dates, transportation choices, durable confirmations, indeterminate booking outcomes, and pending tool operations when present.',
